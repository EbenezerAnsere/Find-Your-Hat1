...
class Field {
    ...
    canFieldBeSolved() {
        ...
        do {
            ...
            if (destination[0] <= -1 || destination[1] <= -1 || this.field[destination[0]] === undefined || this.field[destination[0]][destination[1]] === undefined || this.field[destination[0]][destination[1]] === hole) {} else if (this.field[destination[0]][destination[1]] === hat) {
                return true;
